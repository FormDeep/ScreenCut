...
app_name = "ScreenCut"
version = "1.0.3"
download_url = "https://github.com/VCBSstudio/ScreenCut/releases/download/1.0.3/ScreenCut.1.0.3.dmg"
release_notes_url = "https://github.com/VCBSstudio/ScreenCut/releases/tag/1.0.3"
file_path = "/Users/helinyu/workspace/GitHub/dmg_dir/ScreenCut 1.0.3.dmg"  # 替换为实际路径
